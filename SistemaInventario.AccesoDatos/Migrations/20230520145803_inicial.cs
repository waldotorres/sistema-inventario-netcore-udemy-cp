        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cantidad = table.Column<decimal>(type: "decimal(15,3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductoId = table.Column<int>(type: "int", nullable: false),
                    StockAnterior = table.Column<decimal>(type: "decimal(15,3)", nullable: false),
                    Cantidad = table.Column<decimal>(type: "decimal(15,3)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventariosDetalle_Inventarios_InventarioId",
                        column: x => x.InventarioId,
                        principalTable: "Inventarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventariosDetalle_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventariosDetalle_InventarioId",
                table: "InventariosDetalle",
                column: "InventarioId");

            migrationBuilder.CreateIndex(
                name: "IX_InventariosDetalle_ProductoId",
                table: "InventariosDetalle",
                column: "ProductoId");
